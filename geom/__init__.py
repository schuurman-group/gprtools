...
geom package: molecular geometry and geometry-space tooling.
    ...
    geom.Descriptor, geom.Soap, geom.InversePairDistance,
    geom.RedundantInternals
                                        (descriptor.py; needs ase + dscribe)
"""
...
try:
    from .descriptor import (Descriptor, Soap, InversePairDistance,
                             RedundantInternals)
except ImportError:
    Descriptor = Soap = InversePairDistance = RedundantInternals = None

__all__ = ['Geometry', 'Trajectory', 'Intc', 'Intdef', 'Cart2int',
           'Optimizer', 'OptResult', 'Descriptor', 'Soap',
           'InversePairDistance', 'RedundantInternals']
